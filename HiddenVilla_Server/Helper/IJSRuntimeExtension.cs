...
namespace HiddenVilla_Server.Helper
{
    public static class IJSRuntimeExtension
    {
        ...
        public static async ValueTask SwalSuc(this IJSRuntime JSRuntime, string message)
        {
            await JSRuntime.InvokeVoidAsync("ShowToastr", "swalSuc", message);
        }
        public static async ValueTask SwalError(this IJSRuntime JSRuntime, string message)
        {
            await JSRuntime.InvokeVoidAsync("ShowToastr", "swalError", message);
        }
    }
}
